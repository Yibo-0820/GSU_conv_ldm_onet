...
class DiffusionModel(nn.Module):
    ...
    @torch.no_grad()
    def sample(self, dim, batch_size, noise=None, clip_denoised = False, traj=False, cond=None):
    ...
    def generate_unconditional(self, num_samples):
        ...
        with torch.no_grad():
            ...
            # samp,_ = self.ddim_sample(1024, 20, noise=None, clip_denoised = False, traj=False, cond=None)
